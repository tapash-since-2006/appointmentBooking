...
export const Navbar = () => {
  ...
  return (
    <div className='flex item-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        ...
        <div></div>
        <div></div>
        <ul className='hidden md:flex items-start gap-5 font-medium mt-[18px]'>
          <NavLink to='/'>
            <li className='py-1'>
              HOME
            </li>
        ...
        <div className='flex items-center gap-4'>
          {
            ...
            ? <div className='flex items-center gap-2 cursor-pointer group relative'>
              <img className='w-12 h-12  rounded-full' src={userData.image}/>
          ...
          <div className={`${showMenu?'fixed w-full':'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
            ...
            <ul className='flex flex-col items-center gap-2 mt-5 font-medium'>
