...
const RelatedDoctors = ({ speciality, docId }) => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
            <h1 className='text-3xl font-medium'>Others Similar Doctors Available....</h1>
            ...
            <button onClick={() => { navigate('/doctors'); scrollTo(0, 0) }} className='bg-blue-100 text-gray-900 px-12 py-3 rounded-full mt-10'>Click Here for All Dotors Available</button>
        </div>
    )
}
